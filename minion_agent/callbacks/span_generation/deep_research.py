...
class _DeepResearchSpanGeneration(_SpanGeneration):
    ...
    def before_tool_execution(self, context: Context, *args, **kwargs) -> Context:
        tool_name = context.shared.get("tool_name", "unknown_tool")
        tool_description = context.shared.get("tool_description", None)
