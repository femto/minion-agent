...
class _TinyAgentInstrumentor:
    ...
    def instrument(self, tracer: Tracer) -> None:
        ...
        self._original_tool_call = minion_agent.frameworks.tinyagent.ToolExecutor.call_tool
        wrap_function_wrapper(  # type: ignore[no-untyped-call]
            "minion_agent.frameworks.tinyagent",
    ...
    def uninstrument(self) -> None:
        ...
        if self._original_tool_call:
            parent = resolve_path("minion_agent.frameworks.tinyagent", "ToolExecutor")[2]  # type: ignore[no-untyped-call]
