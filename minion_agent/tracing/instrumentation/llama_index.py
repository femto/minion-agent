...
class _LlamaIndexInstrumentor:
    ...
    def instrument(self, tracer: Tracer) -> None:
        ...
        class _MinionAgentEventHandler(BaseEventHandler):
            current_spans: dict[str, Span] = Field(default_factory=dict)

            @classmethod
            def class_name(cls) -> str:
                return "MinionAgentEventHandler"
        ...
        get_dispatcher().add_event_handler(_MinionAgentEventHandler())
    ...
    def uninstrument(self) -> None:
        ...
        dispatcher.event_handlers = [
            ...
            if handler.class_name() != "MinionAgentEventHandler"
        ]
