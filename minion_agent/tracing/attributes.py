...
class GenAI:
    ...
    We only expose the keys that we currently use in `minion-agent`.
    """
...
class MinionAgentAttributes:
    """Span-attribute keys specific to MinionAgent library."""

    VERSION = "minion_agent.version"
    """The minion-agent library version used in the runtime."""
