...
from minion_agent import AgentConfig, AgentFramework
from minion_agent.config import TracingConfig
...
class LlamaIndexAgent(MinionAgent):
    ...
    async def _load_agent(self) -> None:
        ...
        if not llama_index_available:
            msg = "You need to `pip install 'minion-agent[llama_index]'` to use this agent"
